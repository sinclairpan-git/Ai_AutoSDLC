...
| program quality-platform-handoff | `python -m ai_sdlc program quality-platform-handoff` | 查看质量验收默认继承的组件库上下文与质量矩阵 | **可能写 adapter**：命令主体只读；会显示 delivery entry、component packages、quality diagnostics 与 evidence contracts |
