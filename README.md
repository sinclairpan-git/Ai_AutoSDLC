...
`v0.8.7` is the current published framework release. This patch keeps the
...
If you want the published release, install `v0.8.7`. If you are evaluating newer unreleased behavior beyond this tag, prefer the source-checkout path below.

- Current release notes: `docs/releases/v0.8.7.md`
- Windows offline bundle: `ai-sdlc-offline-0.8.7-windows-amd64.zip`
- macOS offline bundle: `ai-sdlc-offline-0.8.7-macos-arm64.tar.gz`
- Linux offline bundle: `ai-sdlc-offline-0.8.7-linux-amd64.tar.gz`
