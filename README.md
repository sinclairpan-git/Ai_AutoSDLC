...
`v0.7.12` is the current published framework release. This patch release hardens offline runtime packaging so macOS, Linux, and Windows release assets must prove they contain and use a bundled Python runtime instead of silently depending on the build runner or a user-managed Python.

If you want the published release, install `v0.7.12`. If you are evaluating newer unreleased behavior beyond this tag, prefer the source-checkout path below.

- Current release notes: `docs/releases/v0.7.12.md`
