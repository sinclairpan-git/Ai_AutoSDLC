...
RELEASE_NOTES_CURRENT_REL = Path("docs") / "releases" / "v0.8.10.md"
...
RELEASE_DOCS_CONSISTENCY_SURFACES: dict[Path, tuple[str, ...]] = {
    ...
    RELEASE_BUILD_WORKFLOW_REL: ("default: v0.8.10",),
    RELEASE_ARTIFACT_SMOKE_WORKFLOW_REL: ("default: v0.8.10",),
    WINDOWS_OFFLINE_SMOKE_WORKFLOW_REL: (
