...
class DecomposeGate:
    ...
    def check(self, context: dict[str, Any]) -> GateResult:
        ...
        if exists:
            ...
            checks.append(GateCheck(name="tasks_count", passed=False, message="tasks.md missing"))
            checks.append(GateCheck(name="has_dependencies", passed=False, message="tasks.md missing"))
