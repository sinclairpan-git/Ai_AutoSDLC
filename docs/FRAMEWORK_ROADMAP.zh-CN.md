...
| P3 | 跨平台首次用户 12 路完整闭环 | **WI224 原生证明 formal；R02 bounded execute 已授权** | 9.5/10 | R02 目标 1–2 人日；完整实现仍估 6–10 人日 | 先证一条路线 | P2 默认入口稳定 |
...
**状态：WI222 P3-A formal/admission 已合并；WI224 正在 formalize 原生发布证明与 R02 bounded execute。** 基于
WI222 的严格证据合同，当前仍为
