...
- [ ] 若本 PR 涉及 release / 安装包 / 版本号：已同步核对 `README.md`、`docs/releases/v0.7.0.md`、`USER_GUIDE.zh-CN.md`、`packaging/offline/README.md` 与 release 资产文案，确保版本入口和平台资产分工一致（当前 staged release 示例：Windows `.zip`，macOS / Linux `.tar.gz`）。
