...
- [ ] 若本 PR 涉及 release / 安装包 / 版本号：已同步核对 `README.md`、`docs/releases/v0.7.7.md`、`USER_GUIDE.zh-CN.md`、`packaging/offline/README.md` 与 release 资产文案，确保版本入口和平台资产分工一致（当前 staged release `v0.7.7`：`ai-sdlc-offline-0.7.7-windows-amd64.zip`、`ai-sdlc-offline-0.7.7-macos-arm64.tar.gz`、`ai-sdlc-offline-0.7.7-linux-amd64.tar.gz`）。
