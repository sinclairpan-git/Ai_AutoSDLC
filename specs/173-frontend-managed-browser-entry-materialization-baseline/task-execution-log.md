...
- `tasks.md` 同步状态：truth sync 已纳入当前批；repo dry-run 待本批 git close-out 后 fresh 回放。
- `plan.md` 同步状态：focused tests、diff hygiene、truth refresh 与 touched-files lint 已完成。
