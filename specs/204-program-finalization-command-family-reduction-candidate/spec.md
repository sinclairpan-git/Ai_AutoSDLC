...
**创建日期**：2026-07-15
**状态**：设计准入草案；formal 合入前仅允许文档与只读测量
**类型**：WP-07 / GAP-04 / L3 candidate implementation
...
当前 docs branch 只冻结 candidate 准入合同。Formal 同 hash 双 PASS 并合入 main 后，独立
...
Formal PR 只允许 canonical WI-204 docs、manifest/truth/checkpoint/handoff state，以及
...
`204/204`。不得新增测试逻辑、放宽其他断言或修改其他测试文件；该例外只反映 WI-204 的五层
source materialization，不属于 candidate 保护 claim。
...
| owner | Codex / `feature/204-program-finalization-command-family-reduction-candidate` |
