...
- Product=`+≤48/-≥406`；proof=`+≤48`；mechanical truth=`+3`；RC-06 combined=99/101。
...
- [x] **Step 1: 写完四个 pre-close canonical 文档并同步 parent 最小状态**

  不复制 WI216/T66 大型设计，只冻结本 spec 的 13-loader family、预算、impact、stop gate 和回退。

- [x] **Step 2: 注册 manifest 与 sequence**
...
- [x] **Step 5: formal PR 与 detached fresh-main**
...
- [x] **Step 1: 将 12 个 ordinary caller 改为显式 binding**
...
- [x] **Step 2: 用一个 helper 替换 13 个 body**
...
- [x] **Step 3: disposable clone rollback/reapply**
