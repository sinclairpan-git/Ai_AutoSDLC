...
| RC-03 | product additions≤48；proof/test additions≤48；mechanical truth additions≤3；新增产品/测试文件=0；新 private helper≤1；public abstraction=0 |
...
| RC-06 | product48 + proof48 + truth=3 = combined99≤`floor(406×25%)=101`，buffer=2；路线历史保守 subtotal184 后累计≤283≤1,500 |
...
机械 truth 标量必须按canonical sync实际三行计费；combined硬上限101不放宽。若 Ruff 或修复要求突破任一上限，直接缩小或 NO-GO。
...
- **SC-217-002**：proof≤48、truth=3、RC-06 combined=99/101；无新模块、依赖、public abstraction。
