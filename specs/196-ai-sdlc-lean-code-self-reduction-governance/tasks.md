...
| T56 建立 portable/lossless resume reconstruction（active） | standalone | GAP-13 | L2 | T55 已关闭 + WI-198 impact analysis | WI-208；canonical source + status/recover/handoff relocation/detached tests |
