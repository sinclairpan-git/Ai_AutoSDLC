...
| T58 隔离 workitem 只读 adapter side effect（open） | standalone | GAP-15 | L2 / CC-05 | WI-213 formal mainline/fresh-main | 五个只读命令 bytes/output/clean-tree RED→GREEN；`init/link` 写语义保持；双 Agent/Codex/CI/fresh-main |
