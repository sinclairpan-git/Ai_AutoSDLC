...
| T57 修复 YAML quoted-scalar comment-policy false positive（formal ready） | standalone | GAP-14 | L2 | T56/PR #143 与 closure PR #144 已满足；WI-209 Round 5 同一身份双 PASS，formal PR delivery in progress | WI-209；old/new 对称 quoted token span、quoted/plain/literal/real-comment characterization + constraints/full/fresh-main |
