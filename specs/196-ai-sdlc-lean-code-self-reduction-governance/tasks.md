...
| T57 修复 YAML quoted-scalar comment-policy false positive（queued） | standalone | GAP-14 | L2 | T56 fresh-main 已满足；待 WI-209 formal | WI-209；quoted/plain/real-comment characterization + path/syntax-aware parser + constraints/full/fresh-main |
