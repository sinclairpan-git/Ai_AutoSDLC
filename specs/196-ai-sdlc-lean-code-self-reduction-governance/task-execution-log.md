...
- constraints、program validate 与 truth audit PASS；snapshot=`4503b0c2550c...aff5c1`，状态
  `ready/fresh`。CLI handoff 的旧 checkpoint 副作用已恢复，resume-pack/WI208/Cursor protected diff=0，
  WI210 root/scoped handoff byte-identical。
