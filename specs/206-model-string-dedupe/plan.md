...
**硬约束**：1 私有文件、算法12 LOC、文件15 raw LOC、产品 +≤33/-≥216、source additions≤39
...
| 减重有效性 | 18→1、216→12、product net≤-183；wrapper/纯移动 No-Go。 |
| 400/50 | 新文件15 raw LOC、函数12 LOC；历史文件只减少。 |
| RC-06 | cap54，全部 source additions≤39，保留≥15。 |
...
additions≤33、deletions≥216、net≤-183；无 wrapper、public export、依赖或额外代码。
