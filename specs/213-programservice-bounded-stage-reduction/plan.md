...
WI213 formal
  -> fresh-main receipt
  -> T58/GAP-15 standalone fix + fresh-main receipt
...
| GAP-15 | formal 只登记/恢复；T58 独立 RED/GREEN/fresh-main 后才进入 T61A |
...
| GAP-15 | WI213 后续独立 T58 branch/PR | read-only bytes stable；`init/link` unchanged；fresh-main |
