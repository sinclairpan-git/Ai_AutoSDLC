...
**来源**：plan.md + spec.md（FR-009-001 ~ FR-009-012 / SC-009-001 ~ SC-009-005）
...
- **验收标准**：
  ...
  3. 当前 `design/009-frontend-governance-ui-kernel` 分支上的 formal docs 可作为后续继续拆解或执行的稳定基线
