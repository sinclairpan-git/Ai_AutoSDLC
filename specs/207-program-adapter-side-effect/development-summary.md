...
约 99 行 guard 设计达成一致，受影响集合 `195 passed, 1 skipped`，首轮完整 guard 为
`3224 passed, 3 skipped` 且外部 pre/post diff/index/scoped resume/project config 摘要相同。最终仍需在
精简版 final tree 上已重跑 affected=`196 passed, 1 skipped`、full=`3224 passed, 3 skipped`，guard 与
外部 pre/post 摘要均直接相同；完成 exact-tree 双审、repair PR/Codex/checks/merge 与 fresh-main 后才能
关闭 GAP-12。
