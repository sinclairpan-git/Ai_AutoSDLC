...
4. `test_repo_program_manifest.py`：锁定 capability required evidence 为 `121/122/159/200`，并保留 `160-163` provenance。
...
- 更新 capability goal、`spec_refs` 与 required evidence。
...
4. 运行全量 pytest、Ruff、constraints、program validate、truth sync/audit、workitem close-check。
...
| manifest | 121/122/159/200 gate；160-163 provenance | repo manifest test + validate |
